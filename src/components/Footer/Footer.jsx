...
function Footer() {
  return (
    <div classNameName="flex flex-col h-auto">
      <ImageBar />
      <div>
        <footer className="text-center lg:text-left  text-blue-grey-600 lg:mx-4">
          ...
          "
              ...
              <div className="">
                ...
                <div className="border-solid border-2 border-gray-300 rounded-lg w-full flex lg:h-12  h-auto overscroll-x-none">
                  <input type="text" placeholder="Email" className=" lg:p-4" />
                  <button className="border-solid border-2 w-full rounded-lg bg-red-800 text-white">
                    Subscribe
                  </button>
                </div>

                <div className="flex justify-center m-4">
                  <a href="#!" className="mr-6 text-blue-grey-600">
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
                  ...
                  <a href="#!" className="mr-6 text-blue-gray-600">
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
                  ...
                  <a href="#!" className="text-blue-gray-600">
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
